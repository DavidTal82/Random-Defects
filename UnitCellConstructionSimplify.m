...
SavePath = ['\UnitCellArrays\',num2str(vf*100),'PercentVF\'];
save([cd,SavePath,PhaseName,'Defects.mat'],'Defects')
save([cd,SavePath,PhaseName,'Defects_Rejected.mat'],'Defects_rejected')
save([cd,SavePath,PhaseName,'Defects3D.mat'],'volume_3D')

clear Defects Defects_Rejected volume_3D x y z
